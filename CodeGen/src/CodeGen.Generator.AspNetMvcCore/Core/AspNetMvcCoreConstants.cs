namespace CodeGen.Generator.AspNetMvcCore.Core
{
    /// <summary>
    ...
    public static class AspNetMvcCoreConstants
    {
        ...
        /// <summary>NAMESPACE_MODELS</summary>
        public const string NAMESPACE_MODELS = "NAMESPACE_MODELS";

        /// <summary>NAMESPACE_CONTROLLER</summary>
        public const string NAMESPACE_CONTROLLER = "NAMESPACE_CONTROLLER";
        ...
        public const string MODEL_SUFFIX = "MODEL_SUFFIX";

        /// <summary>CONTROLLER_PREFIX</summary>
        public const string CONTROLLER_PREFIX = "CONTROLLER_PREFIX";
        ...
        /// <summary>CREATE_METHODNAME</summary>
        public const string CREATE_METHODNAME = "CREATE_METHODNAME";

        /// <summary>EDIT_METHODNAME</summary>
        public const string EDIT_METHODNAME = "EDIT_METHODNAME";
