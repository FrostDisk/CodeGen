    ...
    public static class {CLASS_NAME_DATAACCESS}
    {
        ...
        public static {PRIMARYKEY_DATATYPE} {SAVE_METHODNAME}({CLASS_NAME_DOMAIN} {INSTANCE_NAME_DOMAIN})
        {
            Parametros parametros = new Parametros
            {
                ...
                /*-- END SECTION VARCHAR */
                /*-- BEGIN SECTION XML AS VAR */new Parametro("@{VAR.PARAMETERNAME}", {INSTANCE_NAME_DOMAIN}.{VAR.PROPERTYNAME}),
                /*-- END SECTION XML */
        ...
        public static async Task<{CLASS_NAME_DOMAIN}> {GETBYID_METHODNAME}{ASYNC_METHODS_SUFFIX}({PRIMARYKEY_DATATYPE} {PRIMARYKEY_LOCAL_VARIABLE})
        {
            ...
            return await {DBHELPER_INSTANCEOBJECT}.{GETENTITY_ASYNC_METHODNAME}("{GETBYID_STORED_PROCEDURE}", parametro, {BUILDFUNCTION_METHODNAME}{ASYNC_METHODS_SUFFIX});
        }
        ...
        private static {CLASS_NAME_DOMAIN} {BUILDFUNCTION_METHODNAME}(IDataReader fila)
        {
            return new {CLASS_NAME_DOMAIN}
            {
                ...
                /*-- END SECTION VARCHAR */
                /*-- BEGIN SECTION XML AS VAR */{VAR.COLUMNNAME} = fila["{VAR.COLUMNNAME}"] != DBNull.Value ? new Func<XmlDocument>(() => { var x = new XmlDocument(); x.LoadXml(fila["{VAR.COLUMNNAME}"].ToString()); return x; })() : new XmlDocument(),
                /*-- END SECTION XML */
